...
public class DeliveryManWorkAreaJPanel extends javax.swing.JPanel {
  ...
  if(order.getDeliveryManName()!=null && order.getDeliveryManName().equals(userAccount.getEmployee().getName())){
    ...
    private void initComponents() {
        ...
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 170, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(108, 58, 530, 96));
